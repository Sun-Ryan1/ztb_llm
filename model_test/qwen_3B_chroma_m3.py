...
class QwenTestConfig:
    ...
    def __init__(self):
        ...
        # 候选Embedding模型配置（第二阶段测试计划要求）- 仅测试bge-m3
        self.embedding_models_config = {
            "bge-m3": {
                "name": "BAAI/bge-m3",
                "local_path": "/mnt/workspace/data/modelscope/cache/bge-m3/BAAI/bge-m3"
            }
        }
        ...
        # 输出目录（包含模型名称）
        self.output_dir = f"./qwen_3b_model_520qa_bge_m3_chromeDB"
